...
public class JoyStickController : MonoBehaviour, IDragHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    private Vector2 inputDirection;           // Direction for movement (normalized)
    ...
    private void Start()
    {
        ...
        movementRange = (bgSize - controllerSize) / 2;
    }
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        float distance = Mathf.Clamp(direction.magnitude, 0f, movementRange);
    ...
    // Get the movement direction for use in your player movement script
